...
class Trainer():
    def __init__(self, env, episodes=500, critic_lr=0.01, actor_lr=0.001, 
    ...
    def train_episode(self):
        ...
        self.agent.learn(obs_list, action_list, reward_list, next_obs_list, done_list)
        return total_reward
    ...
    def train(self):
        ...
        print(f'test_episode={test_reward / 5:f}')